...
| Resource | Description |
|----------|-------------|
| [Vehicle Stats](vehicle-stats.md) | Access vehicle telemetry data (GPS, fuel, engine states) |
| [Vehicle Locations](vehicle-locations.md) | Get current and historical vehicle locations |
| [Trips](trips.md) | Access trip data and history |
...
| Resource | Description |
|----------|-------------|
| [Routes](routes.md) | Manage dispatch routes |
| [Addresses](addresses.md) | Manage addresses and geofences |
| [Route Events](route-events.md) | Access route event data |

## Organization Resources

| Resource | Description |
|----------|-------------|
| [Users](users.md) | Manage organization users |
| [Tags](tags.md) | Manage tags for grouping resources |
| [Contacts](contacts.md) | Manage contacts |

## Integration Resources

| Resource | Description |
|----------|-------------|
| [Webhooks](webhooks.md) | Manage webhook configurations |
| [Gateways](gateways.md) | Access gateway device information |
| [Live Shares](live-shares.md) | Manage live sharing links |

## Industrial Resources

| Resource | Description |
|----------|-------------|
| [Assets](assets.md) | Manage fleet assets with tracking |
