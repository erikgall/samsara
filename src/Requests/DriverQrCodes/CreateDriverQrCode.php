 ...
 *
 * To use this
 * endpoint, select **Write Drivers** under the Drivers category when creating or editing an API token.
 ...
 */
class CreateDriverQrCode extends Request implements HasBody
{
    use HasJsonBody;
