...
/**
 * getIftaJurisdictionReports.
 *
 * Get all jurisdiction IFTA reports for the requested time duration. Data is returned in your
 ...
 */
class GetIftaJurisdictionReports extends Request
{
    ...
    {
        return '/fleet/reports/ifta/jurisdiction';
    }
}
