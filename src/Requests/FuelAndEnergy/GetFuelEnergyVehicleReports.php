 ...
 */
class GetFuelEnergyVehicleReports extends Request
{
     ...
     * @param  string|null  $energyType  The type of energy used by the vehicle.  Valid values: `fuel`, `hybrid`, `electric`
    ...
    {
        return '/fleet/reports/vehicles/fuel-energy';
    }
}
