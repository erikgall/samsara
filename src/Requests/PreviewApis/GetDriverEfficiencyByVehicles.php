...
/**
 * getDriverEfficiencyByVehicles.
 *
 * This endpoint will return driver efficiency data that has been collected for your organization and
 * grouped by vehicle drivers used based on the time parameters passed in. Results are paginated.
 *
 *
 ...
 */
class GetDriverEfficiencyByVehicles extends Request
{
    ...
    {
        return '/preview/driver-efficiency/vehicles';
    }
}
