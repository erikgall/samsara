 ...
 * getEquipmentStats.
 *
 * Returns the last known stats for all equipment. This can be optionally filtered by tags or specific
 * equipment IDs.
 *
 ...
 */
class GetEquipmentStats extends Request
{
