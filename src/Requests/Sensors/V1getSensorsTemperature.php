 ...
 * ambient temperature (and probe temperature if applicable) for the requested sensors.
 *
 *  **Submit
 ...
 */
class V1getSensorsTemperature extends Request implements HasBody
{
    use HasJsonBody;
