 ...
 *
 * Returns vehicle stats during the given time range for all vehicles. This can be optionally filtered
 * by tags or specific vehicle IDs.
 *
 * Related guide: <a href="/docs/telematics"
 * target="_blank">Telematics</a>.
 *
 ...
 * team.
 *
 * To use this endpoint, select **Read Vehicle Statistics** under the Vehicles category when
 * creating or editing an API token. <a
 * href="https://developers.samsara.com/docs/authentication#scopes-for-api-tokens"
 * target="_blank">Learn More.</a>
 */
class GetVehicleStatsHistory extends Request
{
    ...
    {
        return '/fleet/vehicles/stats/history';
    }
}
