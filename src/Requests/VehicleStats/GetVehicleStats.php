 ...
 * getVehicleStats.
 *
 * Returns the last known stats of all vehicles at the given `time`. If no `time` is specified, the
 ...
 */
class GetVehicleStats extends Request
{
