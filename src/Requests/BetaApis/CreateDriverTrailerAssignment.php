 ...
 *
 * To use
 * this endpoint, select **Write Assignments** under the Assignments category when creating or editing
 ...
 */
class CreateDriverTrailerAssignment extends Request implements HasBody
{
    use HasJsonBody;
