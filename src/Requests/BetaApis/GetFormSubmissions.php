 ...
 *
 * **Beta:** This endpoint is in beta and is
 * likely to change before being broadly available. Reach out to your Samsara Representative to have
 * Forms APIs enabled for your organization.
 *
 ...
 *
 * To use
 * this endpoint, select **Read Form Submissions** under the Closed Beta category when creating or
 ...
 */
class GetFormSubmissions extends Request
{
