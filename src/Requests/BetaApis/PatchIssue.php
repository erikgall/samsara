 ...
 * being broadly available. Reach out to your Samsara Representative to have Forms APIs enabled for
 * your organization.
 *
 ...
 *
 * To use this
 * endpoint, select **Write Issues** under the Closed Beta category when creating or editing an API
 ...
 */
class PatchIssue extends Request implements HasBody
{
    use HasJsonBody;
